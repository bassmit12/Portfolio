  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="backdrop-blur-md bg-[#0d1117]/75 border border-[#30363d] rounded-full px-4 py-3 mt-4 flex items-center justify-between">
            ...
            <motion.button
              ...
              className="md:hidden text-[#c9d1d9] hover:text-[#58a6ff] transition-colors rounded-full p-1 hover:bg-[#58a6ff]/10"
      ...
      <motion.div
        ...
        className="fixed inset-0 z-30 md:hidden bg-[#0d1117]/80 backdrop-blur-md"
      >
        <motion.nav
          initial={{ x: "100%" }}
          animate={{ x: isOpen ? 0 : "100%" }}
          transition={{ type: "spring", damping: 20 }}
          className="fixed right-0 top-0 bottom-0 w-3/4 bg-[#161b22] border-l border-[#30363d] p-6 rounded-l-2xl z-40"
